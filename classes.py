...
TypeOfObj.register(CrownObj)    # I know I can use ABC without doing this
...
class Pieces(list):
    ...
    def __remove_empty(self, p):
        ...
        def transpose(a):
            '''goes through rows and columns. remove_blank_rows removes all rows where all elements eval False,
               which 0 does '''
            return zip(*a)
